...
1. ASP.NET Core backend (.NET 6)
   ...
   7. Logging via Serilog to [Loggly](https://loggly.com) (free up to 250MB/day). You could check out logs [yourself](https://mccdbsyncapp.loggly.com/) (credentials: mcc.template.app@gmail.com/dBAeFm7_y5mq3)
1. React frontend
...
1. Rename all files/folders from 'DbSyncApp' to your project name.
...
1. Run backend (Open `webapi/MccSoft.DbSyncApp.sln` in Rider/Visual Studio and hit `F5`)
...
1. Disable Pipeline notifications in Azure (i.e. 'Run stage waiting for approval' and 'Manual validation Pending') https://dev.azure.com/mcctomsk/DbSyncApp/_settings/notifications. Also disable them in your personal profile: https://dev.azure.com/mcctomsk/_usersSettings/notifications
