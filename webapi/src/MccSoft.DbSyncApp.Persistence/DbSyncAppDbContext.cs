...
{
    public class DbSyncAppDbContext
        :
          // DbContext
          ...
          ITransactionFactory
    {
        ...
        public DbSyncAppDbContext(
            DbContextOptions<DbSyncAppDbContext> options,
        ...
        static DbSyncAppDbContext() => NpgsqlConnection.GlobalTypeMapper.MapEnum<ProductType>();
