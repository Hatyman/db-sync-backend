...
using MccSoft.DbSyncApp.App.Utils.Localization;
...
using MccSoft.DbSyncApp.App.Settings;
using MccSoft.DbSyncApp.Domain.Audit;
...
[assembly: InternalsVisibleTo("MccSoft.DbSyncApp.App.Tests")]

namespace MccSoft.DbSyncApp.App
{
    public class Startup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services)
        {
            ...
            //
            // services
            //     .AddSingleton<HealthCheck, DbSyncAppDbHealthCheck>()
        ...
        )
        {
            ...
            _logger.LogSentryTestError(nameof(DbSyncApp));
                        ...
                        config
                            .UseDbContext(
                                ev =>
                                {
                                    ...
                                    DbSyncAppDbContext dbContext =
                                        (DbSyncAppDbContext)ev.EntityFrameworkEvent.GetDbContext();
                                    DatabaseFacade db = dbContext.Database;
                                    DbConnection conn = db.GetDbConnection();
                                    IDbContextTransaction tran = db.CurrentTransaction;
                                    DbSyncAppDbContext auditContext = new DbSyncAppDbContext(
                                        new DbContextOptionsBuilder<DbSyncAppDbContext>().UseNpgsql(
                                            conn
                                        ).Options,
        ...
        protected virtual void ConfigureDatabase(IServiceCollection services)
        {
            ...
            services
                ...
                .AddDbContext<DbSyncAppDbContext>(
                    (provider, opt) =>
                    {
                        opt.UseNpgsql(
                ...
                options =>
                {
                    ...
                    options.AddSecurity(
                        ...
                        new OpenApiSecurityScheme()
                        {
                            ...
                            Description = "DbSyncApp Authentication",
        ...
        protected virtual void ConfigureAuth(IServiceCollection services)
        {
            ...
            services
                ...
                .AddEntityFrameworkStores<DbSyncAppDbContext>()
            ...
            services
                ...
                .AddCore(
                    options =>
                    {
                        options.UseEntityFrameworkCore().UseDbContext<DbSyncAppDbContext>();
                    }
                )
        ...
        protected virtual void RunMigration(IServiceProvider container)
        {
            ...
            var context = scope.ServiceProvider.GetRequiredService<DbSyncAppDbContext>();
